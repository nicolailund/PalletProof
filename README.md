...
Standardfilteret tillader også GS1-lignende parentesformat, fx `(01)08584012360472`. AI(01)-værdier valideres som GTIN-14, når `barcode.validate_gs1_ai01_check_digit = true`. Parenteser bliver saniteret væk i videofilnavnet, så filen ender med et sikkert navn som `01_08584012360472_YYYYMMDD_HHMMSS.mp4`.
